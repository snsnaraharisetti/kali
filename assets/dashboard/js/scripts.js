...
jQuery(function($) {
    ...
    ULTRA_SETTINGS.otherScripts = function() {
        ...
        if ($.isFunction($.fn.tagsinput)) {
            ...
            $("#tagsinput-21").tagsinput({
                tagClass: function() {
                    i++;
                    return "label label-" + colors[i % colors.length];
                }
            });
            $("#tagsinput-22").tagsinput({
                tagClass: function() {
                    i++;
                    return "label label-" + colors[i % colors.length];
                }
            });
            $("#tagsinput-23").tagsinput({
                tagClass: function() {
                    i++;
                    return "label label-" + colors[i % colors.length];
                }
        ...
        if ($.isFunction($.fn.multiSelect)) {
            ...
            $('#my_multi_select14').multiSelect();
            $('#my_multi_select15').multiSelect();
            $('#my_multi_select16').multiSelect();
            $('#my_multi_select17').multiSelect();
