(function ($) {
    ...
    var logoPath =  home_url + "/assets/img/logo.png";
    home_url = home_url + "/wap/home";

    /*-------------------------------------
     jQuery MeanMenu activation code
     --------------------------------------*/
    $('nav#dropdown').meanmenu({siteLogo: "<a href='"+home_url+"' class='logo-mobile-menu'><img src='"+logoPath+"' width='160px' /></a>"});
    ...
    $('#featured-products-carousel1').owlCarousel({
        autoPlay: true,
        slideSpeed: 2000,
        pagination: false,
        navigation: true,
    ...
    $('.arabic').click(function(){
      var rurl = window.location;
       var url = window.location.origin +'/Uae_Etisalat/lang_switch';
      // var url = 'http://localhost/was/Uae_Etisalat/lang_switch';
      $.ajax({
             type: "POST",
             url: url,
             data: "lang=ar",
