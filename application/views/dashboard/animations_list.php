        ...
        <section class="wrapper" style='margin-top:60px;display:inline-block;width:100%;padding:15px 0 0 15px;'>
          <div class="col-lg-12">
            <div class="row">
              ...
              <div class="col-md-3 col-xs-12" style="margin-bottom: 10px;">
                <a href="<?php echo base_url('dashboard/delete-all-animation') ?>" onclick="return confirm('Are you sure you want to delete all animation product?');" class="btn btn-danger">Delete All Animation Product</a>
              </div>
            </div>
          <section class="box ">
              <header class="panel_header">
                  <h2 class="title pull-left">Animation Product List</h2>
              </header>
                            ...
                            <tr>
                              <td><img src="<?php echo base_url(PRODUCT_IMG_PATH.$value->pimg) ?>" style="height: 50px; width: 50px;"></td>
                                ...
                                <td>
                                    ...
                                    <span style="margin-left: 3px;"><a href="<?php echo base_url('dashboard/delete-animation-product/'.$value->product_id)?>" onclick="return confirm('Are you sure you want to delete this product?');" class="fa fa-remove icon-md icon-danger animated fadeIn" title="Delete"><a></span>
                                </td>
                            </tr>
                          <?php endforeach; ?>
                        </tbody>
