							...
							<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
								<div class="services2-box">
									<a href="javascript:void(0)" onclick="buyPopup('<?php echo $value->product_id ?>',
										...
										<img src="<?php echo base_url(PRODUCT_IMG_PATH.$value->pimg) ?>" alt="services" style="height:100px; width:130px">
									</a>
								...
								<?php if($lang == 'ar'){ ?>
									<div class="footer-area-bottom rtl">
										<div class="container">
											<div class="row">
												<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
													<p style="text-align:center">© 2017 بوابة واس جميع الحقوق محفوظة. صمم بواسطةعاع الحلول</p>
												</div>
											</div>
										</div>
									</div>
