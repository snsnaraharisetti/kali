...
<html class="no-js" lang="">
	<head>
        ...
        <title> Deal Of The Day | WAP Portal</title>
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-lg-10 col-md-10 col-sm-10 col-xs-10" >
							<?php if($lang == 'ar'){ ?>
								<h3 class="rtl" style="text-align: center;"> صفقة اليوم <span>الصور </span> </h3>
							<?php }else{ ?>
								<h3 class="ltr" style="text-align: center;">Explore <span>Deal Of The Day</span> </h3>
							<?php } ?>
						</div>
					</div>
					<div class="row">
								...
								<?php if($lang == 'ar'){ ?>
									<div class="footer-area-bottom rtl">
										<div class="container">
											<div class="row">
												<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
													<p style="text-align:center">© 2017 بوابة واس جميع الحقوق محفوظة. صمم بواسطة الحلول</p>
												</div>
											</div>
										</div>
									</div>
