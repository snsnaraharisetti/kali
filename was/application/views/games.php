    ...
    <body>
				...
				<div class="container">
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" >
								<?php if($lang == 'ar'){ ?>
									<h3 class="rtl" style="text-align: right;">إستكشاف <span>الصور </span>
								...
								<?php }else{ ?>
									<h3 class="ltr" style="text-align: right;">Explore <span>Games</span>
										<span style="color:#000">
											<select class="ltr schange" style="padding: 8px 5px;">
							...
							<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
								<div class="services2-box">
									<a href="javascript:void(0)" onclick="buyPopup('<?php echo $value->product_id ?>',
										...
										<img src="<?php echo base_url(PRODUCT_IMG_PATH.$value->pimg) ?>" alt="services" style="width: 130px; height:100px;">
									</a>
								...
								<?php if($lang == 'ar'){ ?>
									<div class="footer-area-bottom rtl">
										<div class="container">
											<div class="row">
												<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
													<p style="text-align:center">© 2017 بوابة واس جميع الحقوق محفوظة. صمم بواسطةاع الحلول</p>
												</div>
											</div>
										</div>
									</div>
	    ...
	    <?php include 'script.php'; ?>
			...
			$('.schange').change(function(){
				var sid = $('.schange').val();
				var url = "<?= base_url('Uae_Etisalat/games-filter') ?>";
				var data = "sid="+sid;
				$.ajax({
	             type: "POST",
	             url: url,
