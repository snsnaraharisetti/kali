    ...
    <body>
				...
				<div class="container">
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" >
								...
								<?php }else{ ?>
									<h3 class="ltr" style="text-align: right;">Explore <span>Music</span>
										<span style="color:#000">
	    ...
	    <?php include 'script.php'; ?>
			...
			$('.schange').change(function(){
				var sid = $('.schange').val();
				var url = "<?= base_url('Uae_Etisalat/music-filter') ?>";
				var data = "sid="+sid;
				$.ajax({
	             type: "POST",
	             url: url,
										 ...
										 $('#plist').append(
											 '<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">'+
				 								'<div class="services2-box">'+
				 									...
				 									'</a>'+
													'<h3 class="rtl">'+value.price +'درهم إماراتي</h3>'+
				 								'</div>'+
				 							'</div>'
										 );
									 });
