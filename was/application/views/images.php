    ...
    <body>
				...
				<div class="container">
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" >
								...
								<?php }else{ ?>
									<h3 class="ltr" style="text-align: center;">Explore <span>Images</span>
									<span style="color:#000">
								...
								<?php if($lang == 'ar'){ ?>
									<div class="footer-area-bottom rtl">
										<div class="container">
											<div class="row">
												<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
													<p style="text-align:center">© 2017 بوابة واس جميع الحقوق محفوظة. صمم بواسطةأنا شعاع الحلول</p>
												</div>
											</div>
										</div>
									</div>
								...
								<?php if($lang == 'ar'){ ?>
									<div class="inner-product-details-right rtl">
										...
										<ul class="inner-product-details-cart">
											<li><a href="javascript:void(0)">يشترى</a></li>
										</ul>
									</div>
								<?php }else{ ?>
	    ...
	    <?php include 'script.php'; ?>
			...
			$('.schange').change(function(){
				var sid = $('.schange').val();
				var url = "<?= base_url('Uae_Etisalat/image-filter') ?>";
				var data = "sid="+sid;
				$.ajax({
	             type: "POST",
	             url: url,
